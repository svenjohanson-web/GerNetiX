...
// NimBLE's UUID initializer macro uses C99 nested designated initializers
// (`.u.type`), which GCC 8 rejects when this mixed Arduino/ESP-IDF component
// is compiled as GNU C++11. Positional aggregate initialization expresses the
// same layout and remains valid in both the current toolchain and newer C++.
static const ble_uuid128_t flashbox_service_uuid = {
  {BLE_UUID_TYPE_128},
  {0x01, 0xea, 0x04, 0xa0, 0x79, 0x64, 0xf6, 0xbb,
   0x89, 0x4a, 0xdf, 0x62, 0x20, 0x4b, 0xa4, 0xbc},
};
static const ble_uuid128_t flashbox_status_uuid = {
  {BLE_UUID_TYPE_128},
  {0x01, 0xea, 0x04, 0xa0, 0x79, 0x64, 0xf6, 0xbb,
   0x89, 0x4a, 0xdf, 0x62, 0x21, 0x4b, 0xa4, 0xbc},
};
static const ble_uuid128_t flashbox_capabilities_uuid = {
  {BLE_UUID_TYPE_128},
  {0x01, 0xea, 0x04, 0xa0, 0x79, 0x64, 0xf6, 0xbb,
