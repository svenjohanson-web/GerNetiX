...
const EXPECTED_IDS = [
  ...
  "elab-tpl-free-rc-highpass",
  "elab-tpl-free-rc-lowpass",
  "elab-tpl-free-series-rlc",
...
test("prüft reale Startcodes der Templates", () => {
  const expectedStartCodeById = {
    ...
    "elab-tpl-free-rc-highpass": "// Freie AC-Simulation: RC-Hochpass mit Bode-Darstellung und SPICE-Netlist.",
    "elab-tpl-free-rc-lowpass": "// Freie AC-Simulation: RC-Tiefpass mit Bode-Darstellung und SPICE-Netlist.",
    "elab-tpl-free-series-rlc": "// Freie AC-Simulation: Serieller RLC-Resonanzkreis mit Messung über dem Widerstand.",
