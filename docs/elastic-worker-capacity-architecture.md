...
| 10 | Streaming-ArtifactStore | vorgeschlagen und durch Messung priorisiert | BYTEA bleibt fuehrend; Hash, Schutzklasse und Streaming sind hinter einem Vertrag gekapselt. Ein warmer realer ARM-Build benoetigte 0,55 s Kompilierung, aber bei rund 14,7 MB Artefakten etwa 15,14 s Gesamtzeit. Der heutige SQL-/WireGuard-Artefaktpfad ist damit als erster realer Engpass gemessen. |
