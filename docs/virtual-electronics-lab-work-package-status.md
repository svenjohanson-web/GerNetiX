...
- 5 bereits definierte Arbeitspakete sind noch offen.
...
| SPICE | SPICE-001 bis SPICE-006 | Simulationsauftrag, Netlistexport, AC-Lernsolver, Bode-Sicht, Providervertrag und Orakelkorpus |
| AC | AC-001 | AC-Kennwerte und erster abfallender Drei-dB-Durchgang |
...
| Reihenfolge | Paket | Inhalt | Abhaengigkeit |
| ---: | --- | --- | --- |
| 1 | ELAB-AC-002 | RC-Hochpass und serieller RLC-Resonanzkreis als weitere Templates | SPICE-003 |
| 1 | ELAB-AC-003 | DOM-freies View-Model fuer Plot, Kennwerte, Tabelle und Zustaende | AC-001 |
| 1 | ELAB-SPICE-007 | Isolierter Web Worker mit Fake-Engine, Timeout und Neustart | SPICE-005 und SPICE-006 |
| 2 | ELAB-AC-004 | AC-Kennwerte und Ergebniszustaende in die bestehende Laborflaeche integrieren | AC-003 |
| 2 | ELAB-SPICE-008 | Ressourcen- und Missbrauchsgates fuer Worker und Ergebnisse | SPICE-007 |

AC-002, AC-003 und SPICE-007 koennen weitgehend parallel beginnen. AC-004 und
SPICE-008 folgen jeweils nach ihrem direkten Vorgaenger.
