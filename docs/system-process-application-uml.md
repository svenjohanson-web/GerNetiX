...
| Project Server | 4800 | `http://127.0.0.1:4800/` | Projektidentitaet, Owner und Rechte; neue Entwicklungsprojekte nur mit privater Forgejo-Bindung und Initialcommit; geschuetzte Basissoftware-Referenz auf einen freigegebenen Commit; commitgebundene Builds; projektweiser SQL-Altimport |
| Forgejo | intern, Betriebsaufnahme offen | nur Backend-Netz; kein oeffentlicher Listener | Private Kundenprojekte sowie getrennte geschuetzte Repositories fuer ESP32-/ESP8266-Basissoftware, Nexi, FlashBox und Spielesammlung; Staging-Veroeffentlichung und Migration noch auszufuehren |
