...
| Forgejo | intern auf Staging in Betrieb | nur Backend-Netz; kein oeffentlicher Listener | Private Kundenprojekte sowie getrennte geschuetzte Repositories fuer ESP32-/ESP8266-Basissoftware, Nexi, FlashBox, Spielesammlung ESP8266-OLED und Spielesammlung ESP32-S3-Touch; die geschuetzten Systemquellen sind auf Staging veroeffentlicht, eine Kunden-Bestandsmigration ist mangels erhaltungswuerdigem Altbestand nicht erforderlich |
