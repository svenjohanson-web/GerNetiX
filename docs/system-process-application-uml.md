...
- Das Community-Portal fuehrt Forum, Ideenwerkstatt, Projekt-Showcase und Elektronik-Kleinanzeigen als vier getrennte Einstiege zusammen. Suche, aktuelle Aktivitaeten und persoenliche Zaehler verdichten deren bestehende API-Sichten ohne eine zweite fachliche Persistenz. Der Showcase publiziert nur nach serverseitiger Besitzpruefung eine begrenzte redigierte Projektkopie in `community_project_showcases`; Listen liefern keine Quelltexte und ungepruefte Inhalte bleiben `community_unverified`.
