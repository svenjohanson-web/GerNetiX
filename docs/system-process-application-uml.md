...
flowchart LR
  ...
  subgraph platformInfrastructure["Technische Infrastruktur"]
    ...
    forgejo["Forgejo<br/>private Projektrepositories + Git-Historie<br/>intern, Zielarchitektur"]
  end
