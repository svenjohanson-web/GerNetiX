...
flowchart LR
  ...
  subgraph localTools["Lokale Tools / Build-Artefakte"]
    ...
    requirementsWorkshop["Anforderungswerkstatt Offline-Modus<br/>deterministisches Lernprojekt<br/>kein Serverprozess erforderlich"]
...
| Identity Server mit KI-Anforderungswerkstatt | 4300 | `/app/requirements-workshop/` und `POST /api/platform/requirements-workshop/feedback` | Sitzungsgeschuetzter OpenAI-Verstaendnisspiegel mit Structured Output, AI-Usage-Preflight, pseudonymisiertem Safety-Identifier und `store: false`; trennt Verstandenes, Annahmen, Wissensluecken, funktionale und nichtfunktionale Anforderungen sowie Akzeptanzkriterien; Eingabe und Ergebnis werden nicht fachlich persistiert |
...
- Die KI-Anforderungswerkstatt ist Teil des gemeinsamen angemeldeten Plattform-Frontends unter `/app/requirements-workshop/`. Identity leitet den Account aus der Sitzung ab und ruft OpenAI Responses erst nach AI-Usage-Preflight mit `store: false`, pseudonymisiertem Safety-Identifier und strengem Structured Output auf. Der Verstaendnisspiegel trennt Verstandenes, Annahmen, Wissensluecken, funktionale und nichtfunktionale Anforderungen, Regeln, Randbedingungen und testbare Akzeptanzkriterien; er persistiert weder Eingabe noch Ergebnis als fachlichen Lernstand. Unter `tools/requirements-workshop` bleibt ein eigenstaendiger deterministischer Offline-Lernpfad ohne Account, Backend oder Provideraufruf erhalten. Browserdirekte Provider-Schluessel sind in beiden Varianten ausgeschlossen.
