...
| Forgejo | intern auf Staging in Betrieb | nur Backend-Netz; kein oeffentlicher Listener | Private Kundenprojekte sowie getrennte geschuetzte Repositories fuer Basissoftware, Produkte und Board-Support; lokal ist ES3C28P als versioniertes Board-Support-Manifest vorbereitet. Die bereits geschuetzten Systemquellen sind auf Staging veroeffentlicht, eine Kunden-Bestandsmigration ist mangels erhaltungswuerdigem Altbestand nicht erforderlich |
