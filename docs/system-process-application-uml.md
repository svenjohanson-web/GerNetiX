...
| Forgejo | intern, Betriebsaufnahme offen | nur Backend-Netz; kein oeffentlicher Listener in der ersten Stufe | Ziel fuer private Git-Repositories, Systemvorlagen und echte Historie; Adapter lokal implementiert, gepinnter Container, eigene PostgreSQL-Datenbank `forgejo`, `forgejo_data` und Staging-Nachweis noch offen |
