...
In der IDE besitzt jede konkrete IoT-Device-Instanz unter `Konfiguration/Hardware/Boardkonfiguration` eine eigene Auswahl der im Projekt verwendeten Boardfunktionen. Der Hardware Catalog beschreibt diese Funktionen hierarchisch: MCU-Peripherie wie GPIO, ADC, PWM, I2C, SPI, UART, PCNT, RMT, I2S, TWAI, Motor-PWM, Hardware-Timer und Interrupts bildet die unterste Ebene. Darueber liegen Runtime-Abstraktionen wie Digital-I/O, Analogeingang, serielle Busse, Ereignisse, Wellenformausgabe und Zeitgeber. Treiber und Steuerungen bilden die oberste Ebene, beispielsweise Servo-Treiber, DC-Motortreiber/H-Bruecke, Schrittmotor-Treiber und Synchronmotor-/BLDC-/PMSM-Steuerung.
