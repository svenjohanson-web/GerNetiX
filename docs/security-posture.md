...
| Mobile Operator-PWA | Installierbare Plattform-/Push-Oberflaeche nur aus dem WireGuard-Netz | Teilweise | 2026-07-15: Nginx schirmt `/app/` und `/api/push/` auf das VPN-Netz ab; iPhone-Peer aktiv. VAPID-Konfiguration, Deployment und iPhone-PWA-Test stehen aus |
