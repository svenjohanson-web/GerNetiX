...
| Web-Push-Zustellung | Accountgebundene PWA-Subscriptions, gezielter Versand an Device-Owner und getrennte Sicherheitsalarm-Empfaenger | Teilweise | 2026-07-15: SQLite-persistierte Account-Subscriptions, Account-Filterung und Contract-Tests vorhanden; Board-Ereignisse sind nur ueber eine token-geschuetzte interne Identity-Route vorgesehen. VAPID-Konfiguration und End-to-End-Nachweis auf iPhone/VPS stehen aus |
...
| Ressourcen-Kostenkontrolle | Zentral nachregelbare Kontingente je Nutzerprofil | Teilweise | 2026-07-16: Project Server persistiert Profilgrenzen in SQLite; Admin Tool zeigt und aendert Projekt-/Speicher-/Traffic-Limits. Free ist auf fuenf Entwicklungsprojekte und begrenzten Projektspeicher beschraenkt; Durchsetzung fuer monatlichen Traffic steht noch aus |
