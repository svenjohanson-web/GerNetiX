...
| Öffentlicher Demo-Katalog | Eigene SQLite-Datei und Docker-Volume ausschließlich für redaktionell veröffentlichte Demo-Metadaten und immutable `firmware.bin`-Releases; keine Konto-, Projekt-, Inventar- oder Telemetriedaten | Teilweise | 2026-07-17: Schema, Prüfsummenprüfung, ausschließlich USB-Release-Modell und Tests implementiert; geschützter Publish-Token, Reverse-Proxy und Backup-/Restore-Nachweis stehen vor dem VPS-Deployment aus |
