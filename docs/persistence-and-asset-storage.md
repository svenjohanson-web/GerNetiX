...
| Operations und Admin-Zugang | PostgreSQL `gernetix_runtime`, Tabellen `operations_*` und `admin_access_*` | `runtime_postgres_data` | Admin-Consents, Audit, Systemereignisse, Schnittstellenstatistik, minimierte Nutzeraktionsereignisse mit Action-/Span-Korrelation, Linkziele, Linkfundstellen, Linkprüfhistorie, Admin-Konten und Sessions |
