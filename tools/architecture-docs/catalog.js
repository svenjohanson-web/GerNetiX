...
const curatedDocuments = {
  ...
  "docs/school-deployment-architecture.md": { category: "system", status: "maintained", order: 7 },
  "docs/project-background-worker-specification.md": { category: "system", status: "maintained", order: 8 },
  "docs/persistence-and-asset-storage.md": { category: "system", status: "maintained", order: 9 },
  "docs/forgejo-project-repository-work-packages.md": { category: "system", status: "maintained", order: 10 },
  "docs/generated/architecture-view.md": { category: "system", status: "generated", order: 11 },
  ...
  "docs/nexi-bottom-up-test-roadmap.md": { category: "development", status: "maintained", order: 8 },
