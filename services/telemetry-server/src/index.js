...
const { startMqttTelemetryAdapter } = require("./mqtt-telemetry-adapter");
...
module.exports = { createConfig, createHttpApp, SqliteTelemetryRepository, TelemetryService, createDefaultTelemetryServer, startMqttTelemetryAdapter };
