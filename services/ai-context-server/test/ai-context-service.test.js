...
test("prompt foundations are centrally available from ai context", () => {
  ...
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("Ziel und Funktion"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("technischen Loesungsraum"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("frei antworten"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("Messdaten ermitteln"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("Handy oder Browser"));
  ...
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("Nenne mir deine Pattern"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("welches Pattern am ehesten passt"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("Datenlogger"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("Remote-Steuerung"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("lokale Regel-/Steuerstrecke"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("Observer/Benachrichtigung"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("synchronisiertes Zustandsmodell"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("Zugangskontrollsystem"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("Solarzelle"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("Hell/Dunkel-Erkennung"));
  assert.ok(prompts.find((prompt) => prompt.route_task === "architecture_discovery").content.includes("lokalen Netzwerks"));
