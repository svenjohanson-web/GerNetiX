...
function defaultPolicy() {
  return {
    ...
    allowed_models: ["gpt-4.1-mini", "gpt-4.1", "gpt-5", "gpt-5-mini", "gpt-5-nano", "gpt-5.5", "gpt-5.5-mini", "gpt-5.6-sol", "gpt-5.6", "gpt-5.6-terra", "gpt-5.6-luna", "community-assistant-basic", "llama3.1", "llama3.2:3b"],
    premium_models: ["gpt-4.1", "gpt-5", "gpt-5.5", "gpt-5.6-sol", "gpt-5.6", "gpt-5.6-terra"],
    model_pricing: {
      ...
      "gpt-4.1-mini": { credits_per_1k_input_tokens: 1000, credits_per_1k_output_tokens: 1000, provider_cost_per_1k_tokens: 0.0006 },
      "gpt-4.1": { credits_per_1k_input_tokens: 1000, credits_per_1k_output_tokens: 1000, provider_cost_per_1k_tokens: 0.003 },
      "gpt-5": { credits_per_1k_input_tokens: 1000, credits_per_1k_output_tokens: 1000, provider_cost_per_1k_tokens: 0.004 },
      "gpt-5-mini": { credits_per_1k_input_tokens: 1000, credits_per_1k_output_tokens: 1000, provider_cost_per_1k_tokens: 0.0008 },
      "gpt-5.5": { credits_per_1k_input_tokens: 1000, credits_per_1k_output_tokens: 1000, provider_cost_per_1k_tokens: 0.005 },
      "gpt-5.5-mini": { credits_per_1k_input_tokens: 1000, credits_per_1k_output_tokens: 1000, provider_cost_per_1k_tokens: 0.001 },
      ...
      "community-assistant-basic": { credits_per_1k_input_tokens: 1000, credits_per_1k_output_tokens: 1000, provider_cost_per_1k_tokens: 0.0004 },
      "llama3.1": { credits_per_1k_input_tokens: 1000, credits_per_1k_output_tokens: 1000, provider_cost_per_1k_tokens: 0 },
      "llama3.2:3b": { credits_per_1k_input_tokens: 1000, credits_per_1k_output_tokens: 1000, provider_cost_per_1k_tokens: 0 },
    },
    source_ratings: {
      local_llm: {
        source_id: "local_llm",
