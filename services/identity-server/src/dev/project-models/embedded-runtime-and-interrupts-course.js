const modelData = require("./embedded-runtime-and-interrupts-course.json");

function createEmbeddedRuntimeAndInterruptsCourseModel() {
...
module.exports = { createEmbeddedRuntimeAndInterruptsCourseModel };
