const modelData = require("./avr-framework-resource-budget-course.json");

function createAvrFrameworkResourceBudgetCourseModel() {
...
module.exports = { createAvrFrameworkResourceBudgetCourseModel };
