const modelData = require("./home-automation-sensors-course.json");

function createHomeAutomationSensorsCourseModel() {
  function createProject(project, step) {
    const definition = modelData.project;
    return project(definition.slug, definition.title, definition.area, definition.summary,
  ...
  return { createProject, createSources: () => clone(modelData.sources), createViewManifest, slug: modelData.slug };
}
...
module.exports = { createHomeAutomationSensorsCourseModel };
