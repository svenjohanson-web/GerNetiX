const modelData = require("./motor-control-basics-course.json");

function createMotorControlBasicsCourseModel() {
...
module.exports = { createMotorControlBasicsCourseModel };
