const modelData = require("./proximity-sensor-radar-course.json");

function createProximitySensorRadarCourseModel() {
...
module.exports = { createProximitySensorRadarCourseModel };
