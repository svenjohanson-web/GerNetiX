const modelData = require("./home-automation-network-course.json");

function createHomeAutomationNetworkCourseModel() {
...
module.exports = { createHomeAutomationNetworkCourseModel };
