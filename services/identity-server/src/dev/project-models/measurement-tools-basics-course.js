const modelData = require("./measurement-tools-basics-course.json");

function createMeasurementToolsBasicsCourseModel() {
...
module.exports = { createMeasurementToolsBasicsCourseModel };
