const modelData = require("./chicken-coop-door-smartphone-app-course.json");
const { developmentLessonCatalog } = require("./development-lesson-catalog");

function createChickenCoopDoorSmartphoneAppCourseModel() {
...
module.exports = { createChickenCoopDoorSmartphoneAppCourseModel };
