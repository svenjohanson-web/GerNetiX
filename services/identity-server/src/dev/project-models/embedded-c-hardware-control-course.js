const modelData = require("./embedded-c-hardware-control-course.json");

function createEmbeddedCHardwareControlCourseModel() {
  ...
  function createSources() { return clone(modelData.sources); }
...
module.exports = { createEmbeddedCHardwareControlCourseModel };
