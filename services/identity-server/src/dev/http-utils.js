...
function normalizeAppPath(pathname) {
  ...
  if (/^\/(auth|dashboard|learn|development-platform(?:\/hardware)?|ide|projects|devices|device-management(?:\/(?:provisioning|inventory|recovery))?|builds|downloads|billing|help)\/?$/.test(stripped)) return "/index.html";
  return stripped;
}
