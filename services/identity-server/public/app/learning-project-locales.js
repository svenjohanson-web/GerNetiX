const LearningProjectLocales = (() => {
  const projects = {
    ...
    "programming-fundamentals": ["Programming fundamentals", "Learn with small JavaScript examples how values, decisions, loops and functions form a program."],
    ...
    "build-your-own-proximity-sensor": ["Bouw je eigen naderingssensor", "Onderzoek een FMCW-radarmodule en ontwikkel daaruit een navolgbare nabijheids- of aanwezigheidsdetector."],
      "programming-fundamentals": ["Basiskennis programmeren", "Leer met kleine JavaScript-voorbeelden hoe waarden, beslissingen, lussen en functies een programma vormen."],
