  ...
  const topics = [
    ...
    },
    {
      ...
      children: [
        { id: "from-problem-to-system", title: "Vom Problem zu technischen Grundlagen", articleId: "from-problem-to-system", access: "public", subchapters: [
          ...
          { id: "engineering-thinking-craft", title: "Planung, Ausführung und Nachweis" },
    ...
    },
    {
      ...
      children: [
        ...
        { id: "actuators", title: "Aktoren", articleId: "actuators", subchapters: [
          { id: "actuator-motor-theory", title: "Motoren und Antriebe" },
        ] },
      ],
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        { id: "home-server-internet-security", title: "Home-Server sicher betreiben: Risiken der Internetfreigabe", articleId: "home-server-internet-security" },
    ...
    },
    {
      ...
      children: [
        ...
        { id: "security-basics", title: "Security in vernetzten Projekten", articleId: "security-basics", subchapters: [
          { id: "security-goals", title: "Risikoanalyse: Was müssen wir schützen?" },
          { id: "security-prevent-attacks", title: "Wie halten wir Angreifer ab?" },
          { id: "security-detect-attacks", title: "Wie erkennen wir Angreifer?" },
          { id: "security-limit-damage", title: "Wie begrenzen wir den Schaden?" },
        { id: "security-identity-authentication-authorization", title: "Identifikation, Authentifizierung und Autorisierung" },
          { id: "security-sessions-tokens", title: "Sessions, Tokens und Rechte" },
          { id: "security-cryptography-certificates", title: "Verschlüsselung, Zertifikate und Certificate Authorities" },
          { id: "security-attack-scenarios", title: "Typische Angriffsszenarien verstehen" },
          { id: "security-network-technologies", title: "Netzwerktechnologien: IP, DNS, URLs und Ports" },
          { id: "security-mqtt", title: "MQTT sicher einsetzen" },
          { id: "security-network-boundaries", title: "Netzgrenzen: Firewall, NAT und Reverse Proxy" },
          { id: "security-home-server-strategy", title: "Strategie für einen sicher erreichbaren Home-Server" },
          { id: "security-operation", title: "Sicherer Betrieb" },
        ] },
      ],
    },
    {
  ...
  const articles = {
    "from-problem-to-system": {
      ...
      sections: [
        ...
        { id: "engineering-thinking-craft", heading: "Planung, Ausführung und Nachweis", paragraphs: [
    ...
    "server-systems": {
      ...
      sections: [
        ...
        { heading: "Sicherheitsgrenze folgt dem Servermodell", table: { headers: ["Modell", "Wofür du selbst verantwortlich bleibst"], rows: [["Eigener lokaler Server", "Physischer Zugang, Router und Heimnetz, Updates, Konten, Backups sowie die Entscheidung, ob überhaupt etwas ins Internet darf."], ["Dedizierter Server oder VPS", "Betriebssystem, Dienste, Firewall-Regeln, Identitäten, Geheimnisse, Updates, Backups und die Überwachung. Der Anbieter schützt Rechenzentrum und beim VPS die Virtualisierung."], ["Cloud-Dienst", "Identitäten und Rechte, sichere Konfiguration, Daten, Netzfreigaben, Geheimnisse, Protokollierung und Ausgaben. Der Anbieter schützt die jeweilige Plattform bis zu der im Dienstvertrag beschriebenen Grenze."]] }, paragraphs: ["Die Technik ändert sich, die Grundregel nicht: Verantwortung lässt sich nicht einfach mitmieten. Vor der Auswahl sollte klar sein, wer Updates einspielt, Zugänge prüft, Daten wiederherstellt und auf einen Sicherheitsvorfall reagiert."] },
    ...
    "local-servers": {
      ...
      sections: [
        ...
        { heading: "Sicherheit eines lokalen Servers", paragraphs: ["Lokale Kontrolle bedeutet auch lokaler Betrieb: Stromausfall, Netzwerk, Updates, Backups und Fernwartung müssen geplant werden. Ein lokaler Server ersetzt kein Sicherheitskonzept, kann aber Latenz, Datenschutz und Ausfallsicherheit verbessern.", "Die wichtigste Grenze ist: Ein Dienst im Heimnetz ist nicht automatisch für das Internet bestimmt. Verwaltungsoberflächen, Datenbanken und Fernzugänge bleiben am besten im lokalen Netz oder hinter einem VPN. Werden sie per Portfreigabe erreichbar, gelten sie als Internetdienste und brauchen dieselbe Pflege wie ein VPS: klare Zugänge, zeitnahe Updates, Protokollierung und geprüfte Backups."], list: ["Router und WLAN mit aktuellen Updates und getrennten Gästen bzw. IoT-Netzen betreiben.", "Für Administration starke, persönliche Konten und einen privaten Zugang wie VPN verwenden; keine gemeinsamen Standardpasswörter lassen.", "Sicherungen getrennt vom Server aufbewahren und die Wiederherstellung regelmäßig testen.", "Bei Ausfall oder Angriff muss die lokale Kernfunktion einen sicheren Zustand erreichen – sie darf nicht auf Fernzugriff angewiesen sein."] },
      ],
    ...
    "internet-vps": {
      ...
      sections: [
        ...
        { heading: "VPS: ein fest gebuchtes Serverprodukt", paragraphs: ["Ein VPS ist eine logisch getrennte virtuelle Serverinstanz im Rechenzentrum. Du buchst in der Regel ein festes Produkt: eine bestimmte Anzahl virtueller CPUs, eine festgelegte RAM-Größe, Speicherplatz und einen Netzrahmen. Er fühlt sich wie ein eigener Linux-Server an, ohne dass du die physische Hardware betreiben musst.", "Reicht die Leistung später nicht mehr, wechselst du normalerweise bewusst auf einen größeren Tarif oder ergänzt weitere Instanzen. Das ist planbar, aber nicht automatisch unendlich skalierbar. Betriebssystem, Updates, Firewall, Zugänge, Backups und Überwachung bleiben deine Aufgabe."] },
        { heading: "Die vier verbreiteten Betriebsmodelle", table: { headers: ["Modell", "Wie Ressourcen bereitstehen", "Typische Aufgabe"], rows: [
          ...
          ["Klassischer dedizierter Server", "Ein vollständig gemieteter physischer Server im Rechenzentrum. Seine CPUs, sein RAM und seine Laufwerke sind als konkrete Hardware nur für einen Kunden reserviert.", "Dauerlast mit festen Anforderungen, große Datenbanken, spezielle Hardware oder Anwendungen mit planbarer Auslastung."],
          ["VPS (Virtual Private Server)", "Ein fest gebuchtes Paket aus virtuellen CPUs, RAM, Speicher und Netzwerk auf einem gemeinsamen physischen Host. Größer wird es durch Tarifwechsel oder weitere Instanzen.", "Websites, APIs, VPN-Gateways, kleine bis mittlere Datenbanken und klar abgegrenzte Container-Dienste."],
          ["Cloud-Dienste", "Ressourcen werden als nach Verbrauch oder Konfiguration bereitgestellte Bausteine gemietet: zum Beispiel Instanzen, Funktionen, Datenbanken, Objektspeicher oder Queues. Viele Angebote können Leistung automatisch hoch- und herunterfahren.", "Stark schwankende Last, weltweite Reichweite, verwaltete Datenbanken, Objektspeicher, Event-Verarbeitung und elastische Web-Anwendungen."]
        ] } },
        { heading: "Auswirkungen im Alltag", table: { headers: ["Kriterium", "Lokal", "Dediziert", "VPS", "Cloud"], rows: [
          ["Performance", "Sehr kurze Wege zu lokalen Geräten; Internetzugriff hängt am eigenen Anschluss.", "Konstant und gut planbar, da konkrete Hardware reserviert ist.", "Für viele Anwendungen stark genug; die gebuchte Größe setzt jedoch eine feste Obergrenze.", "Kann mit Last wachsen oder schrumpfen; Netzlatenz, Dienstgrenzen und die gewählte Architektur bleiben entscheidend."],
          ...
          ["Skalierbarkeit", "Begrenzt durch die vorhandene Hardware; Aufrüstung oder zweiter Server sind Handarbeit.", "Vertikal durch andere Hardware, horizontal durch weitere Server – jeweils mit Planung, Beschaffung oder Vertrag.", "Vertikal durch einen größeren Tarif, horizontal durch zusätzliche Instanzen. Beides wird bewusst geplant und ausgelöst.", "Elastisch: Je nach Dienst können Instanzen, Speicher, Datenbankkapazität oder parallele Ausführungen automatisch oder kurzfristig mehr und später wieder weniger werden."],
    ...
    "cloud-services": {
      ...
      sections: [
        ...
        { heading: "Sicherheit in der Cloud: gemeinsame Verantwortung", paragraphs: ["Cloud-Anbieter schützen Rechenzentren und – abhängig vom gebuchten Dienst – Teile der Hardware, Virtualisierung und Plattform. Du verantwortest trotzdem, wer sich anmelden darf, welche Rechte diese Personen und Dienste haben, welche Daten gespeichert werden und welche Netzverbindungen oder Schnittstellen geöffnet sind.", "Verwaltete Dienste nehmen Wartungsarbeit ab, aber Fehlkonfigurationen bleiben möglich: ein zu weit berechtigtes Konto, ein öffentlicher Speicherbereich, ein offener Datenbankzugang oder ein veröffentlichter Schlüssel kann Daten gefährden. Deshalb Identitäten und Rechte klein halten, Geheimnisse sicher verwalten, Zugriffe protokollieren, Regionen und Aufbewahrung bewusst wählen sowie Alarm- und Kostenlimits einrichten."] },
    ...
    "security-basics": {
      ...
      sections: [
        { id: "security-goals", heading: "Risikoanalyse: Was müssen wir schützen?", securityDoorIllustrations: [{ afterParagraph: 0, src: "/assets/security-smart-door-lock.png", alt: "Vergleich eines vernetzten Türschlosses im verriegelten und offenen Zustand; nur die berechtigte Person erhält die Statusinformation", title: "1. Türstatus ist eine sensible Information", caption: "An der realen Tür kann jemand den Zustand nur an diesem Ort und zu diesem Zeitpunkt sehen. Der Fernstatus lässt sich dagegen leise, wiederholt und von weit weg abfragen – deshalb ist er eine schützenswerte Information." }, { afterParagraph: 1, src: "/assets/security-smart-door-status-privacy.png", alt: "Offene vernetzte Tür; ihr Status wird nur an ein berechtigtes Smartphone gesendet und für andere Personen verborgen", title: "2. Eine offene Tür ist keine öffentliche Information", caption: "Die cyanfarbene Verbindung zeigt: Nur das berechtigte Smartphone erfährt den Status. Die durchgestrichenen Augen stehen für Personen, die diese Information nicht erhalten sollen." }, { afterParagraph: 2, src: "/assets/security-smart-door-remote-attack.png", alt: "Ein Krimineller sendet über das Internet einen unberechtigten Öffnungsbefehl an ein vernetztes Türschloss; die Tür steht offen, ohne dass eine Brechstange verwendet wird", title: "3. Ein unberechtigter Fernbefehl wäre gefährlich", caption: "Der rote Weg führt vom Angreifer über das Internet zum Schloss. Die offene Tür zeigt die Folge. Die durchgestrichene Brechstange steht für den entscheidenden Unterschied: Ein digitaler Angriff kann ohne sichtbare Gewalt und nahezu lautlos erfolgen." }, { afterParagraph: 3, src: "/assets/security-smart-door-access-rights.png", alt: "Eine Administration fügt einer Person ein zeitlich begrenztes Öffnungsrecht für ein vernetztes Türschloss hinzu", title: "3. Eine Administration vergibt ein begrenztes Öffnungsrecht", caption: "Links die Administration, in der Mitte die kontrollierte Einladung, rechts die neue Person. Die Uhr bedeutet: Das Öffnungsrecht kann zeitlich begrenzt sein." }], paragraphs: ["Security beantwortet eine sehr praktische Frage: Wer oder was darf welche Funktion benutzen – und wie prüft das System, ob diese Person oder dieses Gerät dafür berechtigt ist? Ein vernetztes Türschloss zeigt das gut. In der realen Welt kann grundsätzlich jede Person, die direkt vor der Tür steht, sehen oder vorsichtig prüfen, ob sie verriegelt ist. Das kostet aber Zeit, setzt die Person selbst der Beobachtung aus und liefert nur einen einzelnen Moment. Ein Fernstatus ist technisch etwas anderes: Er kann unbemerkt, von überall und beliebig oft abgefragt werden. Aus einer Beobachtung vor Ort wird damit ein dauerhaft erreichbarer Informationsdienst.", "Das ist keine theoretische Vorsicht. Wer wiederholt sieht, wann eine Tür geschlossen bleibt, wann sie geöffnet wird oder wie lange niemand kommt und geht, kann Abwesenheiten und Gewohnheiten ableiten. Menschen mit krimineller Absicht könnten solche Informationen nutzen, um Einbrüche zu planen. Aber auch ein Unternehmen oder Verkäufer sollte daraus nicht erkennen können, wann jemand wahrscheinlich zu Hause ist, um diese Person gezielt für ein Verkaufsgespräch anzusprechen. Der Türstatus ist kein Werbedatum, sondern private Sicherheitsinformation.", "Noch kritischer als ein ausgespähter Türstatus wäre ein unberechtigter Öffnungsbefehl. Gelingt es jemandem, eine Schwachstelle, ein gestohlenes Konto oder einen zu weitreichenden Fernzugang auszunutzen, kann die Person das Schloss aus der Ferne über das Internet ansprechen. Das kann viel leiser und unauffälliger geschehen als ein Einbruch mit einer Brechstange: Keine Person muss am Haus stehen, keine Tür wird aufgebrochen und Nachbarn sehen oder hören möglicherweise nichts.", "Der legitime Anwendungsfall folgt danach: Eine andere Person darf die Tür vielleicht nur zu bestimmten Zeiten öffnen. Das Schloss darf dafür nur signierte, berechtigte Öffnungsbefehle annehmen. Die Eigentümerin kann weitere Personen einladen oder deren Öffnungsrecht wieder entfernen. Rechte werden also gezielt für eine Identität und die konkrete Aktion ‚Tür öffnen‘ vergeben.", "Ein Gast erhält zum Beispiel ein zeitlich begrenztes Recht zum Öffnen, die Reinigungskraft nur montags zwischen 9 und 12 Uhr, ein Familienmitglied dauerhaft und die Verwaltung zusätzlich das Recht, andere Zugänge zu vergeben. Läuft eine Berechtigung ab oder geht ein Smartphone verloren, kann das Recht serverseitig widerrufen werden. Die Tür muss dabei auch ohne Internet sicher funktionieren: Ein Netzausfall darf sie nicht unkontrolliert öffnen.", "Dabei geht es um vier Ziele. Vertraulichkeit bedeutet: Fremde können nicht sehen, ob jemand zu Hause ist oder wann die Tür geöffnet wurde. Integrität bedeutet: Niemand kann einen Öffnungsbefehl, eine Berechtigung oder das Türprotokoll unbemerkt verfälschen. Verfügbarkeit bedeutet: Berechtigte Personen können die Tür im vorgesehenen Rahmen nutzen und das Schloss bleibt bei Störungen in einem sicheren Zustand. Nachvollziehbarkeit bedeutet: Wichtige Öffnungen, Einladungen, Rechteänderungen und Fehler können später geprüft werden.", "Security ist keine Anhäufung einzelner Maßnahmen, sondern ein zusammenhängendes Konzept. Es beginnt mit vier Fragen: Welche Funktionen und Daten möchten wir schützen? Was passiert, wenn sie kompromittiert werden? Wo können potenzielle Angreifer überhaupt ansetzen? Und wie halten wir sie davon ab? Die folgenden Abschnitte beantworten vor allem diese letzte Frage: Identifikation, Authentifizierung und Autorisierung begrenzen, wer etwas darf; Sitzungen und Tokens sind zeitlich begrenzte Zugangsnachweise; TLS, Zertifikate und Certificate Authorities schützen die Verbindung; Firewall, VPN und Reverse Proxy begrenzen den erreichbaren Weg. Jedes Werkzeug schützt einen anderen Teil des Systems."] },
        { id: "security-prevent-attacks", heading: "Wie halten wir Angreifer ab?", paragraphs: ["Angreifer halten wir nicht mit einem einzelnen Produkt ab, sondern mit mehreren Hürden. Das System prüft Identitäten, gibt nur die nötigen Rechte, schützt Verbindungen und macht unnötige Dienste gar nicht erst erreichbar. So wird ein gestohlenes Konto, ein erratener Zugang oder eine öffentlich erreichbare Schwachstelle nicht sofort zum vollständigen Zugriff.", "Die folgenden Kapitel erklären diese Hürden: Identifikation, Authentifizierung und Autorisierung entscheiden über Rechte; Sessions und Tokens tragen einen begrenzten Zugangsnachweis; TLS und Zertifikate schützen die Verbindung; Firewall, VPN, Reverse Proxy und geschlossene Ports begrenzen die Angriffsfläche. Updates, sichere Konfiguration, Eingabeprüfung und Rate Limits ergänzen diese Schutzschichten."] },
        { id: "security-detect-attacks", heading: "Wie erkennen wir Angreifer?", paragraphs: ["Nicht jeder Angriff lässt sich sicher verhindern. Deshalb brauchen wir Hinweise darauf, dass etwas Ungewöhnliches geschieht: viele fehlgeschlagene Anmeldungen, Zugriffe aus unerwarteten Netzen, ein neues Gerät, ungewöhnlich viele Befehle oder Änderungen an Berechtigungen.", "Protokolle machen solche Ereignisse nachvollziehbar. Monitoring fasst sie zusammen, und Alarmierung informiert bei wichtigen oder wiederholten Auffälligkeiten. Protokolle dürfen dabei keine Passwörter, Tokens oder privaten Inhalte enthalten – sie sollen bei der Untersuchung helfen, nicht selbst ein neues Risiko schaffen."] },
        { id: "security-limit-damage", heading: "Wie begrenzen wir den Schaden?", paragraphs: ["Wenn ein Konto, Gerät oder Dienst kompromittiert ist, darf es nicht automatisch das ganze Zuhause oder alle Daten betreffen. Kleine Rechte, getrennte Rollen, getrennte Netze oder VLANs und klar begrenzte Dienste verringern den möglichen Schaden. Ein Sensor darf etwa Messwerte senden, aber keine Tür öffnen oder neue Nutzer einladen.", "Zugangsnachweise müssen widerrufbar sein. Bei Verlust werden Sitzungen, Tokens, Schlüssel oder Gerätezugänge gesperrt und ersetzt. Getestete Backups und ein geübter Wiederherstellungsweg helfen nach Fehlern oder Angriffen. Das Ziel ist nicht nur, einen Angriff zu überleben, sondern sicher und nachvollziehbar in einen kontrollierten Zustand zurückzukehren."] },
        { id: "security-identity-authentication-authorization", heading: "Identifikation, Authentifizierung und Autorisierung", table: { headers: ["Begriff", "Frage", "Beispiel"], rows: [["Identifikation", "Welche Identität behauptet jemand oder etwas zu haben?", "Ein Nutzer nennt seinen Kontonamen; ein ESP32 meldet seine Geräte-ID."], ["Authentifizierung", "Kann diese Identität den Nachweis erbringen?", "Der Nutzer bestätigt einen Passkey; das Gerät weist einen privaten Schlüssel nach."], ["Autorisierung", "Welche Aktion darf die bestätigte Identität ausführen?", "Das Konto darf nur eigene Projekte sehen; das Gerät darf nur in sein eigenes MQTT-Thema schreiben."]] }, paragraphs: ["Diese drei Schritte gehören zusammen. Ein Name oder eine Geräte-ID allein ist keine Sicherheit, denn beides kann kopiert oder geraten werden. Erst ein belastbarer Nachweis authentifiziert eine Identität. Erst danach entscheidet die Autorisierung für jede Funktion, ob Lesen, Ändern, Löschen oder Administrieren erlaubt ist.", "Rechte sollten so klein wie möglich sein: Eine Messstation braucht keinen Administratorzugang, ein normaler Nutzer braucht keine Daten anderer Konten und eine öffentliche Website braucht keinen direkten Datenbankzugriff. Dieses Prinzip heißt Least Privilege – minimale, klar begrenzte Rechte."] },
        { id: "security-sessions-tokens", heading: "Sessions, Tokens und Rechte", paragraphs: ["Nach einer erfolgreichen Anmeldung muss ein Dienst nicht bei jedem Klick erneut nach dem Passkey fragen. Er erstellt deshalb eine kurzlebige Sitzung. Im Browser liegt dafür meist ein geschütztes Session-Cookie; bei Programmschnittstellen ist häufig ein Token üblich. Beides ist ein Nachweis für eine bereits geprüfte Anmeldung – kein Passwort und keine dauerhafte Identität.", "Ein Token kann zum Beispiel festhalten, für welches Konto es gilt, wann es abläuft und welche Zielgruppe es verwenden darf. Der Server muss trotzdem bei jeder Anfrage prüfen, ob Signatur, Ablaufzeit, Aussteller und beabsichtigter Dienst stimmen. Ein Token darf nicht einfach als vertrauenswürdiger Text behandelt werden.", "Tokens und Sessions sind wie Zugangskarten: Wer sie besitzt, kann im erlaubten Umfang handeln. Sie gehören daher nie in Quelltext, öffentliche Repositories, Screenshots oder frei lesbare Browser-Speicher. Begrenzte Laufzeiten, Widerruf nach Sicherheitsereignissen, getrennte Tokens je Dienst und sichere Übertragung über HTTPS verringern den Schaden bei Verlust."] },
        { id: "security-cryptography-certificates", heading: "Verschlüsselung, Zertifikate und Certificate Authorities", paragraphs: ["Verschlüsselung schützt den Weg zwischen zwei Endpunkten. Bei HTTPS oder TLS verschlüsselt der Browser die Verbindung zur Website; Dritte im Netzwerk sollen Inhalte, Passwörter oder Tokens nicht mitlesen oder unbemerkt verändern können. TLS allein entscheidet jedoch nicht, wer nach der Verbindung welche Rechte hat – dafür bleiben Authentifizierung und Autorisierung nötig.", "Ein Zertifikat ist eine signierte Aussage: Dieser öffentliche Schlüssel gehört zu dieser Internetadresse oder diesem Dienst. Der Server besitzt dazu den passenden privaten Schlüssel und beweist damit beim Verbindungsaufbau seine Identität. Der private Schlüssel bleibt geheim; das Zertifikat darf verteilt werden.", "Eine Certificate Authority (CA) ist eine vertrauenswürdige Stelle, deren Signaturen Browser und Betriebssysteme prüfen können. Sie bestätigt nach einem definierten Verfahren, dass ein Zertifikat zu einer Domain gehört. Bei Geräten oder internen Diensten kann eine eigene, private CA sinnvoll sein: Sie stellt Zertifikate nur für bekannte Geräte und Dienste aus. Dann müssen deren Zertifikate, Schlüssel, Laufzeiten und Widerruf genauso sorgfältig verwaltet werden wie Benutzerkonten."] },
        { id: "security-attack-scenarios", heading: "Typische Angriffsszenarien verstehen", table: { headers: ["Szenario", "Was dabei passiert", "Wichtige Gegenmaßnahmen"], rows: [["Man in the Middle", "Jemand versucht, sich zwischen Client und Dienst zu schieben – etwa in einem fremden WLAN – um Daten mitzulesen oder Antworten zu verändern.", "HTTPS/TLS verwenden, Zertifikatswarnungen ernst nehmen und die Domain prüfen. Ein gültiges Zertifikat bindet den Dienst an seinen Schlüssel und erschwert das unbemerkte Einschleusen eines falschen Servers."], ["Gestohlene Sitzung oder gestohlenes Token", "Ein Angreifer erhält eine noch gültige Zugangskarte und nutzt sie innerhalb ihrer Rechte.", "Tokens kurz halten, nur verschlüsselt übertragen, nicht in Logs oder Browser-Speicher preisgeben, Sitzungen bei Verlust widerrufen und Rechte klein halten."], ["Phishing", "Eine täuschend echte Seite oder Nachricht bringt Menschen dazu, Zugangsdaten oder Freigaben preiszugeben.", "Adresse und Ursprung prüfen, keine geheimen Codes weitergeben, Passkeys und Mehrfaktor-Authentisierung nutzen. Passkeys helfen, weil sie an die echte Website gebunden sind."], ["Offener oder ungepatchter Dienst", "Ein unnötig erreichbarer oder veralteter Dienst bietet eine zusätzliche Angriffsfläche.", "Nicht benötigte Ports schließen, Adminzugänge privat halten, Updates einspielen, Protokolle überwachen und Backups testen."], ["Zu weitreichende Berechtigung", "Ein echtes Konto oder Gerät darf mehr als seine Aufgabe verlangt; ein Fehler oder Verlust hat dadurch größere Folgen.", "Least Privilege, getrennte Rollen und regelmäßige Prüfung von Konten, Schlüssel und Berechtigungen."]] }, paragraphs: ["Die Szenarien zeigen, warum Security aus mehreren Schichten besteht. TLS schützt den Transportweg, aber nicht gegen eine freiwillig auf einer Phishing-Seite eingegebene Freigabe. Ein korrektes Konto schützt nicht, wenn es unnötig Administratorrechte besitzt. Jede Maßnahme begrenzt einen Teil des Risikos; zusammen entstehen robuste Systeme."] },
        { id: "security-network-technologies", heading: "Netzwerktechnologien: IP, DNS, URLs und Ports", paragraphs: ["Ein Netzwerk braucht Adressen und Regeln für den Weg dorthin. Eine IP-Adresse benennt eine Netzwerkschnittstelle, ähnlich wie eine Zustelladresse. Im Heimnetz sind häufig private Bereiche wie 192.168.x.x oder 10.x.x.x im Einsatz; sie sind im öffentlichen Internet nicht direkt routbar. Eine öffentliche IP-Adresse kann dagegen aus dem Internet erreichbar sein, wenn Router und Firewall dies erlauben.", "Menschen verwenden Namen statt Zahlfolgen. DNS übersetzt einen Namen wie beispiel.de in die passende IP-Adresse. Eine URL beschreibt anschließend genauer, was angesprochen wird: https://beispiel.de:443/app enthält das Protokoll https, den Hostnamen beispiel.de, den optional sichtbaren Port 443 und den Pfad /app. Der Pfad ist nur eine Regel der Web-Anwendung; er öffnet keinen eigenen Netzwerkzugang.", "Ein Port unterscheidet Dienste auf derselben IP-Adresse. Vereinfacht hört ein Webserver auf Port 443 für HTTPS, während ein anderer Dienst auf einem anderen Port wartet. Die Zuordnung IP-Adresse plus Port heißt Socket-Endpunkt. Ein Dienst wird erst erreichbar, wenn er dort lauscht und Netzgrenzen wie Firewall, Router oder Cloud-Regeln den Weg erlauben. Nicht benötigte Ports bleiben geschlossen."] },
        { id: "security-mqtt", heading: "MQTT sicher einsetzen", paragraphs: ["MQTT verbindet Geräte und Dienste über einen Broker. Ein Gerät veröffentlicht Nachrichten zu einem Topic, andere Systeme abonnieren es. Sicherheit bedeutet hier nicht nur, den Broker mit einem Passwort zu versehen: Der Broker muss erkennen, welches konkrete Gerät oder welcher Dienst verbunden ist und exakt festlegen, welche Topics diese Identität lesen oder beschreiben darf.", "TLS verschlüsselt die Verbindung zum Broker. Bei gegenseitigem TLS (mTLS) weist nicht nur der Broker sein Zertifikat vor; auch jedes Gerät besitzt ein eigenes Zertifikat und einen privaten Schlüssel. Der Broker kann dadurch ein Gerät eindeutig prüfen. Alternativ können kurzlebige, gerätespezifische Zugangsdaten verwendet werden. Gemeinsame Zugangsdaten für alle Geräte sind riskant, weil bei Verlust nicht nur ein einzelnes Gerät betroffen ist.", "Eine MQTT-ACL ist eine Liste erlaubter Aktionen pro Identität. Ein Temperatursensor darf zum Beispiel nur unter seinem eigenen Mess-Topic veröffentlichen; er darf weder Befehle für andere Geräte schreiben noch fremde Messwerte abonnieren. Die Geräte-ID sollte der Server aus der geprüften Identität ableiten und nicht allein aus einem frei wählbaren Topic-Text übernehmen."], list: ["Broker nur auf den tatsächlich benötigten Netzwerkwegen erreichbar machen; Administration und Diagnoseports privat halten.", "TLS-Zertifikate, Gerätezugänge und ACLs eindeutig je Gerät oder Dienst verwalten und bei Verlust sperren beziehungsweise rotieren.", "Keine Zugangsdaten, Tokens oder privaten Schlüssel in Firmware-Quelltext, Logs oder öffentliche Repositories legen.", "Nachrichtenformate, Größenlimits, Raten und erlaubte Topics begrenzen; auffällige fehlgeschlagene Anmeldungen und ACL-Verstöße überwachen.", "Wichtige Steuerfunktionen lokal sicher gestalten: Der Ausfall oder Missbrauch einer MQTT-Verbindung darf keinen gefährlichen Zustand verursachen."] },
        { id: "security-network-boundaries", heading: "Netzgrenzen: Firewall, NAT und Reverse Proxy", paragraphs: ["Eine Firewall entscheidet anhand von Regeln, welche Verbindungen passieren dürfen. Gute Regeln erlauben nur erwartete Wege: etwa HTTPS für eine öffentliche Website und einen getrennten, privaten Zugang für Administration. Sie ersetzt keine sicheren Anwendungen, reduziert aber die Angriffsfläche erheblich.", "NAT (Network Address Translation) übersetzt private Adressen eines Heimnetzes auf eine öffentliche Adresse. Von innen nach außen funktioniert das meist automatisch. Eine Portfreigabe oder Weiterleitung hebt diese Grenze für einen ausgewählten Dienst teilweise auf: Anfragen an den öffentlichen Router-Port werden an einen lokalen Server weitergegeben. Das macht genau diesen Dienst zu einem Internetdienst und muss bewusst entschieden werden.", "Ein Reverse Proxy ist ein vorgeschalteter Webserver. Er nimmt HTTPS-Anfragen entgegen, prüft beziehungsweise beendet die TLS-Verbindung und leitet nur erlaubte Pfade an interne Anwendungen weiter. Er kann öffentliche Web-Funktionen von Administration und Datenbanken trennen – aber nur, wenn die internen Dienste nicht zusätzlich frei erreichbar sind. Ein VPN schafft dagegen einen privaten Netzwerkweg für bekannte Geräte und ist für persönliche Administration oft besser geeignet als eine öffentliche Portfreigabe."] },
        { id: "security-home-server-strategy", heading: "Strategie für einen sicher erreichbaren Home-Server", table: { headers: ["Bedarf", "Bevorzugter Weg", "Was öffentlich erreichbar ist"], rows: [["Nur du oder wenige bekannte Personen administrieren den Server", "Keine Portfreigabe für die Anwendung; privater Zugang über VPN oder eine gleichwertig starke, identitätsgebundene Zugriffslösung.", "Idealerweise nur der VPN-Einstieg. Administration, Home-Server-Oberfläche, SSH und Datenbanken bleiben privat."], ["Eine klar abgegrenzte Web-Funktion soll für andere Personen erreichbar sein", "Einen vorgeschalteten, gepflegten Reverse Proxy oder einen vertrauenswürdigen Tunnel nutzen. Dahinter nur genau die öffentliche Anwendung freigeben.", "Der öffentliche Einstieg der Web-Anwendung, typischerweise HTTPS. Keine Adminoberfläche, Datenbank oder Fernwartung."], ["Eine direkte Portfreigabe ist unvermeidbar", "Nur einen einzelnen, dokumentierten Dienst über HTTPS veröffentlichen und ihn wie einen kleinen Produktivdienst betreiben.", "Genau der weitergeleitete Port zu genau einer internen Adresse und Anwendung – nicht der ganze Rechner und nicht das gesamte Heimnetz."]] }, paragraphs: ["Eine Portfreigabe ist eine gezielte Übersetzung am Router: Sie leitet beispielsweise Anfragen an dessen öffentlichen HTTPS-Port zu einem bestimmten Rechner und Port im Heimnetz weiter. Dadurch erhält nicht automatisch jede Person Zugriff auf deinen Rechner. Sie kann aber genau den Dienst erreichen, der dort lauscht. Hat dieser Dienst eine Sicherheitslücke oder wird sein Konto übernommen, kann ein Angreifer unter Umständen auf die Daten und Netzwerkrechte zugreifen, die dieser Dienst besitzt. Wie weit ein Schaden reicht, hängt von der Anwendung, ihren Berechtigungen und der Netztrennung ab.", "Für einen persönlichen Home-Server ist die sichere Standardstrategie deshalb: erst lokal betreiben, Fernadministration über VPN, automatische Portfreigaben durch UPnP deaktivieren oder genau kontrollieren und Router sowie Server aktuell halten. Ein Tunnel oder Reverse Proxy ersetzt diese Regeln nicht; er verschiebt und begrenzt die öffentliche Kante. Für eine wirklich öffentliche Anwendung gehören TLS, starke Anmeldung, getrennte Adminzugänge, minimale Rechte, Updates, Logs, Alarmierung und getestete Backups fest zum Betrieb."], list: ["Nie Datenbank-, SSH-, MQTT-Admin- oder Router-Verwaltung direkt für das Internet freigeben.", "Auf dem Router nur die exakte Weiterleitung prüfen: öffentlicher Port, internes Ziel, Protokoll und Zweck. Alle anderen eingehenden Wege bleiben gesperrt.", "Den Home-Server nach Möglichkeit in ein separates Netz oder VLAN legen. So kann eine kompromittierte Anwendung nicht automatisch auf PCs, Drucker oder andere Geräte zugreifen.", "Vor dem Freigeben testen: Ist nur der erwartete Dienst von außen sichtbar? Funktioniert die Anmeldung? Gibt es aktuelle Backups und einen Plan zum Sperren von Zugängen?"] },
        { id: "security-operation", heading: "Sicherer Betrieb", list: ["Eine einfache Architektur wählen und jede zusätzliche Schnittstelle begründen. Weniger öffentliche Dienste und Rechte bedeuten weniger Angriffsfläche.", "Updates für Betriebssystem, Firmware, Bibliotheken und Anwendungen regelmäßig einspielen; nicht mehr benötigte Dienste, Konten und Schlüssel entfernen.", "Starke, individuelle Identitäten nutzen: Passkeys oder Schlüssel für Administration, Mehrfaktor-Authentisierung wo möglich, keine gemeinsam genutzten Standardzugänge.", "Geheimnisse getrennt vom Quelltext verwalten. Dazu gehören Passwörter, API-Schlüssel, Tokens, private Schlüssel und Wiederherstellungscodes.", "Protokolle, fehlgeschlagene Anmeldungen, Konfigurationsänderungen und Dienstzustand überwachen. Ein Alarm ist nur hilfreich, wenn klar ist, wer ihn prüft und was dann geschieht.", "Backups getrennt speichern und Wiederherstellungen üben. Ein Backup, das nie erfolgreich zurückgespielt wurde, ist kein belastbarer Schutz.", "Vorab festlegen, wie bei Verlust eines Geräts, eines Tokens oder eines Schlüssels reagiert wird: Zugang sperren, Schlüssel rotieren, Sitzungen beenden, Ursache prüfen und betroffene Daten bewerten."] },
      ],
      relatedTopics: ["privacy-basics", "communication-basics", "home-server-internet-security", "internet-vps", "embedded-safety"],
    },
    "glossary-basics": {
    ...
    "actuators": {
      ...
      access: "public",
      sections: [
        { id: "actuator-motor-theory", heading: "Zwei Motorfamilien: Wechselstrom und Gleichstrom", paragraphs: ["Für den Einstieg hilft eine einfache Einteilung: Es gibt Motoren, die an Wechselstrom arbeiten, und Motoren, die an Gleichstrom arbeiten. Beide verwandeln elektrische Energie in Bewegung, aber sie erzeugen ihr drehendes Magnetfeld auf unterschiedliche Weise. Welche Familie passt, entscheidet nicht nur die Steckdose, sondern auch die Aufgabe, die gewünschte Regelbarkeit und die verfügbare Elektronik.", "Wechselstrommotoren haben mehrere Statorspulen. Werden diese zeitlich versetzt bestromt, wandert das Magnetfeld einmal rund im Kreis. Dieses wandernde Feld zieht oder treibt den Rotor an. Die zwei wichtigen Varianten heißen Synchron- und Asynchronmotor. Bei Gleichstrommotoren wird die Energie dagegen als Gleichspannung zugeführt. Beim klassischen Bürstenmotor sorgt ein mechanischer Kommutator dafür, dass die Rotorwicklung beim Drehen passend umgeschaltet wird.", "Diese Familien sind eine Landkarte, keine Kaufentscheidung. Kleine Bastel- und Roboterprojekte beginnen oft mit permanent erregten Bürsten-DC-Motoren, Servos oder Schrittmotoren. Pumpen, Lüfter und Maschinen nutzen häufig Wechselstrommotoren. BLDC- und PMSM-Motoren verbinden eine Gleichspannungsversorgung mit einem elektronisch erzeugten Drehfeld und werden deshalb später als eigene, fortgeschrittene Variante erklärt."] },
        { id: "actuator-synchronous-machines", heading: "Synchronmaschinen: mit einem drehenden Magnetfeld mitlaufen", paragraphs: ["Stell dir einen Stabmagneten auf einem kleinen Drehteller vor. Wenn du außen herum ein Magnetfeld langsam im Kreis wandern lässt, versucht der Magnet, diesem Feld zu folgen. Genau dieses Grundprinzip ist bei einer Synchronmaschine leicht zu sehen: Im festen äußeren Teil, dem Stator, erzeugen Spulen ein wanderndes Magnetfeld. Im drehbaren inneren Teil, dem Rotor, sitzt ein Magnet oder ein elektromagnetisch erzeugtes Magnetfeld.", "Das wandernde Feld zieht den Rotor immer weiter mit. Dreht sich das Feld einmal pro Sekunde, dreht sich der Rotor – solange er nicht überlastet ist – ebenfalls einmal pro Sekunde. Deshalb heißt diese Maschine synchron: Rotor und Magnetfeld laufen im gleichen Takt. Die Spulen des Stators werden dafür in einer passenden Reihenfolge bestromt. Bei großen Maschinen kommt die Reihenfolge meist aus dem Stromnetz oder einem Frequenzumrichter, bei kleinen bürstenlosen Motoren aus einer Elektronik.", "Das Bild hilft auch bei der Auswahl: Eine Synchronmaschine ist besonders gut, wenn die Elektronik das Drehfeld gezielt formen und die Bewegung effizient oder genau steuern soll. Viele BLDC- und PMSM-Motoren gehören in diese Familie. Wie die Elektronik erkennt, wo der Rotor gerade steht, und die Spulen weiterschaltet, folgt später beim BLDC."], table: { headers: ["Teil", "Einfache Aufgabe"], rows: [["Stator", "bleibt fest und erzeugt mit Spulen ein wanderndes Magnetfeld"], ["Rotor", "dreht sich und folgt diesem Magnetfeld"], ["Elektronik oder Netz", "bestromt die Spulen in der richtigen Reihenfolge"], ["Synchron", "Rotor und Magnetfeld drehen sich im gleichen Takt"]] } },
        { id: "actuator-asynchronous-machines", heading: "Asynchronmaschinen: das Feld zieht den Rotor hinter sich her", paragraphs: ["Bei einem Asynchronmotor erzeugt der Stator ebenfalls ein drehendes Magnetfeld. Der Rotor enthält aber oft keinen eigenen Permanentmagneten. Stattdessen besteht er vereinfacht aus leitenden Stäben. Das wandernde Feld erzeugt darin elektrische Ströme – ähnlich wie ein bewegter Magnet in einer Spule Strom erzeugen kann.", "Diese Ströme machen den Rotor selbst zu einem Magneten. Er wird vom Statorfeld mitgezogen, bleibt aber immer ein kleines Stück langsamer. Nur wenn das Feld am Rotor vorbeiwandert, werden weiter Ströme induziert und kann Drehmoment entstehen. Dieser kleine Geschwindigkeitsunterschied heißt Schlupf. Darum heißt der Motor asynchron: Rotor und Statorfeld drehen nicht exakt gleich schnell.", "Asynchronmotoren sind robust und in Pumpen, Lüftern und vielen Maschinen sehr verbreitet. Direkt am Wechselstromnetz laufen sie mit einer durch Netzfrequenz und Motoraufbau bestimmten Drehzahl. Soll die Drehzahl gezielt verändert werden, nutzt man einen Frequenzumrichter – also eine Leistungselektronik, die ein passendes neues Drehfeld erzeugt."] },
        { id: "actuator-dc-motors", heading: "Gleichstrommotoren: Reihenschluss, Nebenschluss und permanent erregt", paragraphs: ["Beim klassischen Bürsten-Gleichstrommotor übernimmt der Motor selbst das Weiterschalten der Rotorwicklung. Während sich der Rotor dreht, schalten Bürsten und Kommutator die Wicklung um. So bleibt das Rotorfeld passend zum festen Feld des Stators ausgerichtet und der Motor dreht weiter. Von außen genügt eine Gleichspannung; für die andere Richtung vertauscht eine H-Brücke die Polarität am Motor.", "Die Namen beschreiben, wie das Statorfeld entsteht. Beim Reihenschlussmotor liegen Feldwicklung und Rotorwicklung in Reihe. Er kann ein sehr hohes Anlaufdrehmoment liefern, seine Drehzahl kann ohne passende Last aber stark ansteigen. Beim Nebenschlussmotor liegt die Feldwicklung parallel zum Rotor. Sein Feld bleibt dadurch vergleichsweise konstant und die Drehzahl ist unter wechselnder Last besser beherrschbar. Beide Bauarten sind klassische Maschinenkonzepte mit Feldwicklungen.", "Beim permanent erregten Bürsten-DC-Motor erzeugen stattdessen feste Magnete das Statorfeld. Das spart eine Feldwicklung und macht kleine Motoren günstig, kompakt und einfach anzusteuern. Deshalb findet man diese Bauart häufig in Spielzeug, kleinen Pumpen, Getriebemotoren und ersten Lernaufbauten. Günstig bedeutet aber nicht unkritisch: Anlauf- und Blockierstrom, Bürstenverschleiß, Störungen und mechanische Last gehören weiterhin zur Auslegung."], table: { headers: ["DC-Bauart", "Statorfeld", "Einsteiger-Einordnung"], rows: [["Reihenschluss", "Feldwicklung liegt in Reihe mit dem Rotor", "hohes Anlaufdrehmoment; ohne Last nicht einfach unbeaufsichtigt betreiben"], ["Nebenschluss", "Feldwicklung liegt parallel zum Rotor", "vergleichsweise konstantes Feld und besser beherrschbare Drehzahl"], ["Permanent erregt", "feste Magnete statt Feldwicklung", "typischer kleiner, günstiger Bürsten-DC-Motor für Lern- und Hobbyprojekte"]] } },
        { id: "actuator-bldc-basics", heading: "BLDC: Gleichspannung hinein, elektronisches Drehfeld heraus", paragraphs: ["Ein BLDC-Motor hat keine Bürsten und keinen mechanischen Kommutator. Sein Rotor trägt meist Permanentmagnete, seine Spulen sitzen im Stator. Eine Elektronik muss die Spulen im richtigen Moment weiterschalten. Dieses elektronische Weiterschalten heißt Kommutierung. Sie braucht die Rotorlage – zum Beispiel von Hall-Sensoren, einem Encoder oder einer sensorlosen Schätzung aus den Motorsignalen.", "Die typische Leistungsschaltung dafür ist eine B6-Brücke: sechs Schalter bilden drei Halbbrücken für die drei Motorphasen. Die Brücke kennt nur die festen Spannungen des Gleichspannungs-Zwischenkreises; sie kann also keine perfekte Sinusspannung direkt ausgeben. Mit schnellem PWM-Schalten wird eine gewünschte mittlere Phasenspannung angenähert. Die Induktivität der Motorwicklungen glättet die schnellen Schaltanteile. Mit einer Stromregelung können dadurch annähernd sinusförmige Phasenströme entstehen – das sorgt für ein gleichmäßiges Drehfeld und ruhigen Lauf.", "Der BLDC wird meist aus einer Gleichspannungsquelle wie Akku oder Netzteil versorgt, ist von seinem Motorprinzip aber eine permanent erregte Synchronmaschine: Der Rotor folgt dem elektronisch erzeugten Drehfeld. Für ein erstes Lernprojekt ist deshalb ein Bürsten-DC-Motor mit Transistor oder H-Brücke viel einfacher. BLDC-Regelung ist die nächste Stufe, wenn Grundlagen zu PWM, Treibern, Strom und Rotorlage sicher sitzen."], table: { headers: ["Motor", "Wer übernimmt die Kommutierung?", "Einfacher Einstieg"], rows: [["Bürsten-DC", "Bürsten und Kommutator im Motor", "Transistor für eine Richtung, H-Brücke für zwei Richtungen"], ["BLDC / PMSM", "Elektronik schaltet die Statorphasen nach Rotorlage", "dreiphasiger Inverter, oft B6-Brücke; für Fortgeschrittene"], ["Schrittmotor", "Treiber bestromt Phasen in einer Schrittfolge", "STEP/DIR- oder 4-Phasen-Treiber"], ["Servo", "Regler im Servo kombiniert Motor, Sensor und Getriebe", "Positions- oder Geschwindigkeitssignal"]] } },
        { id: "actuator-motors-and-drives", heading: "Motoren und Antriebe auswählen", paragraphs: ["Die Auswahl beginnt nicht mit einem Motortyp, sondern mit der Bewegungsaufgabe: Soll sich etwas dauerhaft drehen, eine genaue Position erreichen, eine definierte Strecke fahren oder eine Klappe gegen eine Last öffnen? Dazu kommen Drehmoment, Geschwindigkeit, Weg, Einschaltdauer, Geräusch und die Frage, was bei einem Fehler passieren darf.", "Ein Gleichstrommotor dreht kontinuierlich und ist für Lüfter, Räder oder kleine Pumpen geeignet. Seine Drehzahl lässt sich häufig über PWM beeinflussen; für die Drehrichtung braucht er eine H-Brücke. Ein Servo enthält Motor, Getriebe, Positionsmessung und Regelung bereits im Gehäuse. Er folgt einem Positionssignal und eignet sich für begrenzte Winkel, etwa einen kleinen Riegel. Ein Schrittmotor bewegt sich in diskreten Schritten und ist praktisch für reproduzierbare Wege, braucht aber einen passenden Treiber und verliert ohne Rückmeldung bei Überlast möglicherweise seine reale Position.", "Ein Linearantrieb wandelt eine Drehbewegung in einen Hub um und wird nach Kraft, Weg und Geschwindigkeit gewählt. BLDC- und PMSM-Antriebe sind effizient und leistungsfähig, ihre Regelung mit Leistungsteil und Rotorlage ist jedoch deutlich anspruchsvoller. Getriebe, Mechanik und Endlagen sind immer Teil des Antriebs: Ein passender Motor allein garantiert noch keine sichere Bewegung."], table: { headers: ["Antrieb", "Passt gut, wenn …", "Wichtig für die Steuerung"], rows: [["DC-Motor", "eine Welle kontinuierlich drehen soll", "PWM für Drehzahl; H-Brücke für Richtung; echte Position nur mit zusätzlichem Sensor"], ["Servo", "ein begrenzter Winkel gezielt erreicht werden soll", "Positionssignal, stabile Versorgung und mechanische Begrenzung"], ["Schrittmotor", "ein Weg in kleinen, reproduzierbaren Schritten gefahren wird", "STEP/DIR-Treiber, Beschleunigung; Endschalter oder Encoder für sichere Referenz"], ["Linearantrieb", "eine Klappe, ein Riegel oder eine Schiene bewegt wird", "Richtung, Endlagen, Einklemmschutz und ausreichende Stromversorgung"], ["BLDC / PMSM", "Effizienz oder Leistung entscheidend ist", "spezialisierter 3-Phasen-Treiber, Rotorlage und Schutzfunktionen"]] } },
        { id: "actuator-motor-control", heading: "Motoransteuerung: Leistungsteil und Firmware", paragraphs: ["Motoransteuerung verbindet Elektronik und Software. Die Firmware entscheidet, wann, wie schnell und in welche Richtung sich etwas bewegen soll. Ein Leistungsteil setzt diesen kleinen Steuerbefehl in den benötigten Strom um. Der GPIO steuert deshalb einen Treiber – nie direkt den Motor.", "Für einen DC-Motor mit nur einer Richtung kann ein geeigneter MOSFET-Treiber genügen. Soll der Motor vorwärts und rückwärts laufen, schaltet eine H-Brücke die Polarität. PWM legt dabei nicht einfach eine kleinere Spannung an, sondern schaltet die Versorgung schnell ein und aus; Motor und Treiber reagieren auf den mittleren Energieeintrag. Frequenz, Tastgrad, Stromspitzen und Erwärmung müssen zum Motor und Treiber passen.", "Die Stromversorgung wird nach Anlauf- und Blockierstrom ausgelegt, nicht nur nach dem Wert im Leerlauf. Ein Motor kann beim Start oder wenn er mechanisch blockiert deutlich mehr Strom ziehen. Gemeinsame Masse, kurze Leistungswege, Schutz gegen Verpolung, passende Sicherung und ausreichende Pufferung verhindern, dass der Motor die Versorgung des Mikrocontrollers einbrechen lässt. Der Treiber oder eine Schutzbeschaltung übernimmt außerdem den sicheren Weg für die beim Abschalten entstehende Energie."], learningProjects: [{ model: "Lernprojekt", title: "Motoransteuerung mit einem kleinen DC-Motor", description: "Wähle eine Bewegungsaufgabe, verbinde einen Motor über einen fertigen H-Brücken-Treiber und entwickle eine sichere PWM-Steuerung mit Endschalter und Zeitlimit.", href: "/app/learn/?catalog=motor-control-basics" }] },
        { id: "actuator-safe-motion", heading: "Sicher bewegen: Rückmeldung und Fehlerfälle", paragraphs: ["Eine Bewegung ist erst abgeschlossen, wenn das System sie überprüft hat. Ein Endschalter, Reed-Kontakt, Encoder oder Stromsensor kann melden, ob eine Endlage erreicht wurde, sich die Welle tatsächlich dreht oder etwas blockiert. Ohne Rückmeldung weiß die Firmware bei einem DC-Motor meist nur, dass sie Energie angefordert hat – nicht, ob die Mechanik ihr Ziel erreicht hat.", "Für jede Bewegung gehört ein sicherer Abbruch dazu: maximale Laufzeit, klarer Stopp bei Endlage, Verhalten bei widersprüchlichen Sensoren und ein definierter Zustand nach Neustart. Bei Klappen, Türen oder anderen bewegten Teilen muss außerdem über Einklemmen, unerwartete Hindernisse und manuelle Bedienung nachgedacht werden. Eine Fernverbindung darf keine lokale Sicherheitslogik ersetzen.", "Beginne beim Lernen mit ungefährlicher Kleinspannung und einem kleinen, frei laufenden Motor oder einer Testmechanik. Leistungsstarke Motoren, große Akkus, Netzspannung oder Bewegungen in der Nähe von Menschen brauchen zusätzliche Schutztechnik, geeignete Mechanik und fachkundige Prüfung."] },
